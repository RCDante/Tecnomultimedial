...
void draw() {
  ...
  for (int i = 0; i < numeroDeLineas; i++) {
    for (int j = 0; j < numeroDeLineas; j++) {
      int x1 = inicioX1 + j * espacioDeLineas;
      int x2 = inicioX2 + j * espacioDeLineas;
      int x3 = inicioX3 + j * espacioDeLineas;
